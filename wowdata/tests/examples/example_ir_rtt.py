...
pipe.save_yaml(DATA_DIR / "join.yaml")  # default: NOT schema-locked
pipe2 = Pipeline.load_yaml(DATA_DIR / "join.yaml")  # resolves paths relative to pipelines/

pipe.save_yaml(DATA_DIR / "join.locked.yaml", lock_schema=True, sample_rows=200)
pipe3 = Pipeline.load_yaml(DATA_DIR / "join.locked.yaml")
